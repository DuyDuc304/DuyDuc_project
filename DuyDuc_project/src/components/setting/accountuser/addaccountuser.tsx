                            ...
                            <div className='row-update-device'>
                                <div className='col-update-device'>
                                    ...
                                    <div className='col-update-device-item'>
                                        ...
                                        <div className='box' style={{ width: '540px' }}>
                                            <input readOnly name='VaiTro' onClick={() => this.show('tdv', 'up', 'down')} id='ip' placeholder='Chọn vai trò' style={{ fontSize: '16px', width: '500px', cursor: 'pointer' }}></input>
                                ...
                                <div className='col-update-device'>
                                    ...
                                    <div className='col-update-device-item'>
                                        ...
                                        <div className='box' style={{ width: '540px' }}>
                                            <input readOnly name='TinhTrang' onClick={() => this.show('tt', 'up1', 'down1')} id='iptt' placeholder='Chọn tình trạng' style={{ fontSize: '16px', width: '500px', cursor: 'pointer' }}></input>
